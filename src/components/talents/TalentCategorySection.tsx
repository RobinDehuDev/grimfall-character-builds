...
import { slotsToTalentIdSet, talentIdSetToSlots } from "@/lib/talents";
...
export function TalentCategorySection({
  meta,
  slots,
  activeSlot,
  onSlotClick,
                ...
                return (
                  ...
                  >
                    ...
                    {item ? (
                      <ItemNameTooltip
                        item={item}
                        className="slot__name slot__name--filled text-quality-uncommon"
                      >
                        {item.name}
                      </ItemNameTooltip>
                    ) : (
